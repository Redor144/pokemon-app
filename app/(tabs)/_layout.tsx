...
export default function TabsLayout() {
  ...
  return (
    ...
    >
      <Tabs.Screen
        name="index"
        options={tabBarNavOptions(
          FAVORITE_LABEL,
          Heart,
          { title: FAVORITE_TITLE, subtitle: FAVORITE_SUBTITLE },
          { filled: true },
        )}
      />
      <Tabs.Screen
        name="pokemon-list"
        options={tabBarNavOptions(POKEDEX_LABEL, List, {
          title: POKEDEX_TITLE,
          subtitle: POKEDEX_SUBTITLE,
        })}
      />
      <Tabs.Screen
        name="camera"
        options={tabBarNavOptions(CAMERA_LABEL, Camera, {
          title: CAMERA_TITLE,
      ...
      <Tabs.Screen
        name="map"
        options={tabBarNavOptions(MAP_LABEL, Map, {
          title: MAP_TITLE,
